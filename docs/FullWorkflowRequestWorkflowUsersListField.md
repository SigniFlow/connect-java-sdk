...
------------ | ------------- | ------------- | -------------
**actionField** | **BigDecimal** | Refers to the order of signatures from the users. | 
**allowProxyField** | **BigDecimal** | Allow proxy confirmation field. | 
...
**preloadedFaceToFaceSignersField** | **Set&lt;Object&gt;** | Preloaded user&#39;s who will be using the face to face signature field. |  [optional]
...
**workflowUserFieldsField** | [**Set&lt;FullWorkflowRequestWorkflowUserFieldsField&gt;**](FullWorkflowRequestWorkflowUserFieldsField.md) | The list of the workflowed documents field. |  [optional]
