 ...
 */
@ApiModel(description = "#### The response received after a portfolio is created.")
@JsonPropertyOrder({
  CreatePortfolioResponse.JSON_PROPERTY_PORTFOLIO_I_D_FIELD,
  CreatePortfolioResponse.JSON_PROPERTY_RESULT_FIELD
})
...
public class CreatePortfolioResponse {
  ...
  public CreatePortfolioResponse portfolioIDField(BigDecimal portfolioIDField) {
  ...
  **/
  @ApiModelProperty(example = "13342", required = true, value = "Document portfolio ID field.")
  ...
  public CreatePortfolioResponse resultField(String resultField) {
  ...
  **/
  ...
  /**
   * Return true if this CreatePortfolioResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.portfolioIDField, createPortfolioResponse.portfolioIDField) &&
        Objects.equals(this.resultField, createPortfolioResponse.resultField);
  }
