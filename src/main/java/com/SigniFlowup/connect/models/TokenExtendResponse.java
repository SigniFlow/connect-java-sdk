 ...
 */
@ApiModel(description = "#### The response returned when requesting the extention of the period of which the toekn is valid.")
@JsonPropertyOrder({
  TokenExtendResponse.JSON_PROPERTY_RESULT_FIELD,
  TokenExtendResponse.JSON_PROPERTY_TOKEN_FIELD
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class TokenExtendResponse {
  ...
  public TokenExtendResponse resultField(String resultField) {
  ...
  **/
  ...
  public TokenExtendResponse tokenField(TokenField tokenField) {
  ...
  **/
  ...
  /**
   * Return true if this TokenExtendResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TokenExtendResponse tokenExtendResponse = (TokenExtendResponse) o;
    return Objects.equals(this.resultField, tokenExtendResponse.resultField) &&
        Objects.equals(this.tokenField, tokenExtendResponse.tokenField);
  }
