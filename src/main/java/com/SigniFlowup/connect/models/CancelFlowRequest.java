 ...
 */
@ApiModel(description = "#### The request sent when a workflow is cancelled.")
@JsonPropertyOrder({
  CancelFlowRequest.JSON_PROPERTY_DOC_I_D_FIELD,
  CancelFlowRequest.JSON_PROPERTY_TOKEN_FIELD
})
...
public class CancelFlowRequest {
  ...
  public CancelFlowRequest docIDField(String docIDField) {
  ...
  **/
  ...
  public CancelFlowRequest tokenField(TokenField tokenField) {
  ...
  **/
  ...
  /**
   * Return true if this CancelFlowRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CancelFlowRequest cancelFlowRequest = (CancelFlowRequest) o;
    return Objects.equals(this.docIDField, cancelFlowRequest.docIDField) &&
        Objects.equals(this.tokenField, cancelFlowRequest.tokenField);
  }
