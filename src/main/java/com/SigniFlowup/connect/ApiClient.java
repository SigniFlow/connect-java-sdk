...
import com.SigniFlowup.connect.auth.Authentication;
import com.SigniFlowup.connect.auth.HttpBasicAuth;
import com.SigniFlowup.connect.auth.HttpBearerAuth;
import com.SigniFlowup.connect.auth.ApiKeyAuth;

@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ApiClient extends JavaTimeFormatter {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected Map<String, String> defaultCookieMap = new HashMap<String, String>();
  protected String basePath = "https://server-url/API/SignFlowAPIServiceRest.svc";
  protected String userAgent;
  private static final Logger log = Logger.getLogger(ApiClient.class.getName());

  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://{serverUrl}/API/SignFlowAPIServiceRest.svc",
      "SigniFlow Instance url",
      new HashMap<String, ServerVariable>() {{
        put("serverUrl", new ServerVariable(
          "No description provided",
          "clientname.signiflow.com",
          new HashSet<String>(
          )
        ));
      }}
    ...
    new ServerConfiguration(
      "https://preprod.signiflow.com/API/SignFlowAPIServiceRest.svc",
      "Pre-Production",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://au.signiflow.com/API/SignFlowAPIServiceRest.svc",
      "Australia Cloud",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://eu.signiflow.com/API/SignFlowAPIServiceRest.svc",
      "Europe Cloud",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://flow.signflow.co.za/API/SignFlowAPIServiceRest.svc",
      "South Africa Cloud",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://latam.signiflow.com/API/SignFlowAPIServiceRest.svc",
      "South America Cloud",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://uk.signiflow.com/API/SignFlowAPIServiceRest.svc",
      "United Kingdom Cloud",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://us.signiflow.com/API/SignFlowAPIServiceRest.svc",
      "United States Cloud",
      new HashMap<String, ServerVariable>()
    )
  ));
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("SigniFlow-Connect-Java/2.20191120.0");
